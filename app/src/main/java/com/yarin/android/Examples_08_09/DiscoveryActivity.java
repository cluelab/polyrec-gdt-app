...
public class DiscoveryActivity  extends ListActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		SamplesUtils.indeterminate(DiscoveryActivity.this, _handler, "Scanning...", _discoveryWorker, new OnDismissListener() {
			public void onDismiss(DialogInterface dialog)
			{
				...
				if (_devices.size()==0){
					...
					Intent enabler = new Intent(getApplicationContext(), Activity01.class);
					startActivity(enabler);
				}
					else
					Toast.makeText(getApplicationContext(), "SELECT DEVICE TO CONNECT", Toast.LENGTH_LONG).show();
				_discoveryFinished = true;
